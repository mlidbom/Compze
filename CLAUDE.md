...
## Common Pitfalls
- **Don't write one test per pluggable component** — use `[PCT]` (see [compze-test-conventions](.claude/rules/path-scoped/compze-test-conventions.md), which loads when touching `test/**`).
