...
/// <summary>
/// Convenience base for a matrix theory attribute with four dimensions. Derive your attribute from this and read the
/// current combination's values from <see cref="CurrentDimensionValue1"/> through <see cref="CurrentDimensionValue4"/>,
...
public abstract class MatrixTheoryAttribute<TDimension1, TDimension2, TDimension3, TDimension4>(
   string? configurationFileName,
   string? sourceFilePath,
   int sourceLineNumber)
   : MatrixTheoryAttribute(configurationFileName: configurationFileName,
                                          dimensionEnumTypes: EnumerableCE.OfTypes<TDimension1, TDimension2, TDimension3, TDimension4>().ToArray(),
