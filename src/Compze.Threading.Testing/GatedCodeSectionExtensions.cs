...
public static class GatedCodeSectionExtensions
{
   ...
   private static IGatedCodeSection LetOneThreadEnter(this IGatedCodeSection @this)
   {
      @this.AssertIsEmpty();
   ...
   private static bool IsEmpty(this IGatedCodeSection @this)
      => @this.EntranceGate.Passed == @this.ExitGate.Passed;

   private static IGatedCodeSection AssertIsEmpty(this IGatedCodeSection @this)
   {
