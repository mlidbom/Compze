...
public partial interface IMonitor
{
   ...
   public static IMonitor WithDefaultTimeout() => new MonitorCE(DefaultTimeout, DefaultTimeout);
   public static IMonitor WithTimeout(TimeSpan timeout) => new MonitorCE(timeout, timeout);

   internal static IAwaitableMonitor CreateAwaitableWithDefaultTimeout() => new MonitorCE(DefaultTimeout, DefaultTimeout);
   internal static IAwaitableMonitor CreateAwaitableWithTimeouts(TimeSpan lockTimeout, TimeSpan waitTimeout) => new MonitorCE(lockTimeout, waitTimeout);
