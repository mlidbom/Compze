...
public partial interface IAwaitableMonitorCE
{
   ...
   public static IAwaitableMonitorCE WithDefaultTimeout() => new IMonitorCE.MonitorCE(DefaultTimeout, DefaultTimeout);
   public static IAwaitableMonitorCE WithTimeouts(TimeSpan lockTimeout, TimeSpan? waitTimeout = null) => new IMonitorCE.MonitorCE(lockTimeout, waitTimeout ?? lockTimeout);
