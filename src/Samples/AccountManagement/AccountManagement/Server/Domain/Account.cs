...
class Account : Aggregate<Account, AccountEvent.Root, AccountEvent.Implementation.Root>, IAccountResourceData
{
   ...
   /// </summary>
   internal static (RegistrationAttemptStatus Status, Account? Registered) Register(Guid accountId, Email email ,Password password, IInProcessHypermediaNavigator navigator)
   {
