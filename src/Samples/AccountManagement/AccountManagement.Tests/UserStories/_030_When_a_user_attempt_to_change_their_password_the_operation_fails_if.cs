...
public class _030_When_a_user_attempt_to_change_their_password_the_operation_fails_if(string pluggableComponentsCombination) : UserStoryTest(pluggableComponentsCombination)
{
