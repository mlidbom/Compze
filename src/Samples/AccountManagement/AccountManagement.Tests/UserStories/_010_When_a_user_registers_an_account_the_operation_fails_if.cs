...
public class _010_When_a_user_registers_an_account_the_operation_fails_if(string pluggableComponentsCombination) : UserStoryTest(pluggableComponentsCombination)
{
