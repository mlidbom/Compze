...
static class DomainTypeMapper
{
   ...
   //To make this as easy as possible for you Compz will detect missing mappings and throw an exception telling exactly which lines of code you need to paste into the method below.
