...
public static partial class TessageHandlerRegistrarWithDependencyInjectionSupportExtensions
{
   ...
   {
      @this.TessagingRegistrar.ForTevent(handler);
      return @this;
   }
   ...
   {
      @this.TessagingRegistrar.ForTevent<TTevent>(tevent => handler(tevent, @this.Resolve<TDependency1>()));
      return @this;
   }
   ...
   {
      @this.TessagingRegistrar.ForTevent<TTevent>(tevent => handler(tevent, @this.Resolve<TDependency1>(), @this.Resolve<TDependency2>()));
      return @this;
   }
}
