...
public static class Pipe
{
   ...
   public static unit _<TValue>(this TValue _, Action action) => UnitConvert.Invoke(action);
   ...
   ///<summary> Executes <paramref name="action"/>, ignoring the previous value, and returns a <see cref="unit"/>.  Useful for chaining statements that return void.</summary>
   public static unit _then<TValue>(this TValue _, Action action) => UnitConvert.Invoke(action);
