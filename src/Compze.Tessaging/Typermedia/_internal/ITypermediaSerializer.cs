...
namespace Compze.Tessaging.Typermedia._internal;
...
///<remarks>Each conversation protocol serializes independently: Tessaging through <see cref="Compze.Tessaging.TessageBus._internal.ITessagingSerializer"/>, and<br/>
