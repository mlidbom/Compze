...
> **The `Compze.Typermedia` package folded into `Compze.Tessaging` (the Typermedia sibling of the Tessaging
...
- `ISessionLocalTypermediaNavigator` is `ILocalTypermediaNavigatorSession` — the navigator named first, the session it is last.
