...
namespace Compze.Tessaging.Typermedia.Client.Private;
...
static class TypermediaClientRouterRegistrar
{
   public static IComponentRegistrar TypermediaClientRouter(this IComponentRegistrar registrar)
      => registrar.Register(Private.TypermediaClientRouter.RegisterWith);
}
   ...
   public static void RegisterWith(IComponentRegistrar registrar)
      => registrar.Register(
            Singleton.For<ITypermediaClientRouter, ITypermediaRouting>().CreatedBy(
               (ITypeMap typeMap, ITypermediaTransport transport, IEndpointInformationQueryTransport endpointDiscoveryQueryTransport)
                  => new TypermediaClientRouter(typeMap, transport, endpointDiscoveryQueryTransport)));

   TypermediaClientRouter(ITypeMap typeMap, ITypermediaTransport transport, IEndpointInformationQueryTransport endpointDiscoveryQueryTransport)
   {
      _typeMap = typeMap;
