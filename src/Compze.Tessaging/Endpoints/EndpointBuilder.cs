...
using Compze.Tessaging.Internals.BestEffortDelivery;
...
public abstract class EndpointBuilder<TConcreteBuilder> where TConcreteBuilder : EndpointBuilder<TConcreteBuilder>
{
   ...
   HandlerAvailabilityPatience _handlerAvailabilityPatience = Internals.HandlerAvailability.HandlerAvailabilityPatience.Default;
