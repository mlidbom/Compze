...
static class NamedPipeTransportClient
{
   ...
   /// A handler exception on the server side surfaces here as a <see cref="TessageDispatchingFailedException"/> carrying the server-side exception's type and detail.</summary>
