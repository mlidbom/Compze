...
public class TessagesInFlightTracker(ITypeIdentifierMapper typeMapper) : ITessagesInFlightTracker
{
   ...
   class NonThreadSafeImplementation(ITypeIdentifierMapper typeMapper)
   {
