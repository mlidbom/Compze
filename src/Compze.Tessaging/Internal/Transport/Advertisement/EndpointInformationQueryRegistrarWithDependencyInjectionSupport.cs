...
public class EndpointInformationQueryRegistrarWithDependencyInjectionSupport(EndpointInformationQueryExecutor executor)
{
   ...
   public EndpointInformationQueryRegistrarWithDependencyInjectionSupport ForQuery<TQuery, TResult>(
   ...
   public EndpointInformationQueryRegistrarWithDependencyInjectionSupport ForQuery<TQuery, TDependency1, TResult>(
   ...
   internal EndpointInformationQueryRegistrarWithDependencyInjectionSupport ForQuery<TQuery, TDependency1, TDependency2, TResult>(
   ...
   public EndpointInformationQueryRegistrarWithDependencyInjectionSupport ForQuery<TQuery, TDependency1, TDependency2, TDependency3, TDependency4, TResult>(
