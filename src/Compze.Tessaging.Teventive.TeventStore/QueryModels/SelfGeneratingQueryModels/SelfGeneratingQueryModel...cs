   ...
   where TTaggregateTevent : class, ITaggregateTevent
{
   ...
   protected SelfGeneratingQueryModel() : base(null!) => ContractAssertion.Argument.Fulfills(typeof(TTaggregateTevent).IsInterface);
...
#pragma warning restore CS0618 // Type or member is obsolete
   ...
   {
      ContractAssertion.State.Fulfills(Version == 0);
