...
public static class MySqlEndpointPersistenceRegistrar
{
   ///<summary>Declares the endpoint's persistence: the MySQL database reached through <paramref name="connectionStringName"/> —<br/>
   ...
   public static IComponentRegistrar MySqlEndpointPersistence(this IComponentRegistrar registrar, string connectionStringName) =>
