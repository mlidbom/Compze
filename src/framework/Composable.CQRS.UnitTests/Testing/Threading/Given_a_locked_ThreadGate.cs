...
[TestFixture] public class Given_a_locked_ThreadGate
{
   ...
   {
      [Test] public void Within_20_milliseconds_all_threads_are_blocked_on_Passthrough_and_none_have_passed_the_gate()
      {
         ...
         fixture.Gate.Await(20.Milliseconds(), () => fixture.Gate.Queued == fixture.NumberOfThreads);
