...
abstract class DocumentDbTestsBase([NotNull] string pluggableComponentsCombination) : DuplicateByPluggableComponentTest(pluggableComponentsCombination)
{
   ...
   protected IServiceLocator CreateServiceLocator() => TestWiringHelper.SetupTestingServiceLocator(
      builder
         => builder.TypeMapper
                   .Map<Compze.Tests.Persistence.DocumentDb.User>("96f37428-04ca-4f60-858a-785d26ee7576")
                   .Map<Compze.Tests.Persistence.DocumentDb.Email>("648191d9-bfae-45c0-b824-d322d01fa64c")
                   .Map<Compze.Tests.Persistence.DocumentDb.Dog>("ca527ca3-d352-4674-9133-2747756f45b3")
                   .Map<Compze.Tests.Persistence.DocumentDb.Person>("64133a9b-1279-4029-9469-2d63d4f9ceaa")
