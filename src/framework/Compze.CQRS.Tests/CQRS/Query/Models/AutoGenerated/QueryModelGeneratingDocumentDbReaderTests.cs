...
using Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events;
using Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.Implementation;
using Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.PropertyUpdated;
...
namespace Compze.Tests.CQRS.Query.Models.AutoGenerated
{
    public class QueryModelGeneratingDocumentDbReaderTests(string pluggableComponentsCombination) : DuplicateByPluggableComponentTest(pluggableComponentsCombination)
    {
        ...
        public void CreateContainer()
        {
            ...
            _serviceLocator.Resolve<ITypeMappingRegistar>()
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.MyAccount>("f17eab2f-d0ae-4363-b1ff-85bc6a1b9b5d")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.AccountEvent>("de6d74a5-c039-4f85-b51b-081c1b83e3f3")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.IAccountDeletedEvent>("03598100-598e-4d22-80a4-075f144f9f6c")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.IAccountEvent>("6dd0fad7-91cb-4dd5-a654-b3595d9151c8")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.IAccountRegisteredEvent>("463593ad-61c8-4aea-8a68-9e30899a38fb")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.IEmailChangedEvent>("b36def96-72a6-43eb-b4ce-730e9b16e758")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.Implementation.AccountDeletedEvent>("eb8df880-3fa0-49df-81c3-73b43ad8aeb8")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.Implementation.AccountRegisteredEvent>("9a1ca37c-e6b6-4eea-b553-7125aade02b2")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.Implementation.EmailChangedEvent>("a5b1c528-a41c-4401-956a-6b08092b64cd")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.PropertyUpdated.IAccountEmailPropertyUpdatedEvent>("e6ec9ac8-f317-4883-b450-ee4e4e9f6978")
                           .Map<Compze.Tests.CQRS.Query.Models.AutoGenerated.Domain.Events.PropertyUpdated.IAccountPasswordPropertyUpdatedEvent>("0595f981-9adc-472a-b394-e1da44f4e8a9");
    ...
    namespace Domain
    {
        ...
        class MyAccount : Aggregate<MyAccount,AccountEvent, IAccountEvent>
        {
            ...
            public void ChangeEmail(string newEmail) => Publish(new EmailChangedEvent(newEmail));
            ...
            public void Delete() => Publish(new AccountDeletedEvent());
        }
        ...
        namespace Events
        {
            ...
            {
                class AccountRegisteredEvent(Guid accountId, string email, string password) : AccountEvent(accountId), IAccountRegisteredEvent
                {
                   public string Email { get; private set; } = email;
                    public string Password { get; private set; } = password;
                }

                class EmailChangedEvent(string newEmail) : AccountEvent, IEmailChangedEvent
                {
