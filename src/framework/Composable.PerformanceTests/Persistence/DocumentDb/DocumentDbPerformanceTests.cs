...
{
   [Test] public void Saves_100_documents_in_milliseconds_msSql_75_MySql_400_InMemory_8_PgSql_100_Orcl_100_DB2_300()
   {
      ServiceLocator.ExecuteInIsolatedScope(() =>
      {
         ...
         TimeAsserter.Execute(
            ...
            iterations: 100,
            maxTotal: TestEnv.PersistenceLayer.ValueFor(db2: 300, memory: 8, msSql: 75, mySql: 400, orcl: 100, pgSql: 75).Milliseconds().EnvMultiply(instrumented:2.2, unoptimized:1.3)
         );
      });
   }
