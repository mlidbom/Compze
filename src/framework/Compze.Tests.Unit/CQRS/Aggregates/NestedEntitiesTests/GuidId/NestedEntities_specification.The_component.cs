...
public static partial class NestedEntities_specification
{
   public partial class After_constructing_root_aggregate_with_name_root_and_slaving_a_query_model_to_the_aggregates_events
   {
      ...
      {
         readonly Component _agComponent;
         readonly QueryModels.Component _qmComponent;

         public The_component()
         {
            _agComponent = Aggregate.Component;
            _qmComponent = QueryModel.Component;
         }
         [XFact] public void Component_Name_is_empty_string() => _agComponent.Name.Should().Be("");
         ...
         {
            public After_calling_rename_with_string_newName() => _agComponent.Rename("newName");

            [XFact] public void Component_Name_is_newName() => _agComponent.Name.Should().Be("newName");
