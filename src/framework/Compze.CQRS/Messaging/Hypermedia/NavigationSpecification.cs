...
{
   internal static NavigationSpecification Post(IAtMostOnceHypermediaCommand command) => new VoidCommand(command);
   ...
   internal static NavigationSpecification<TResult> Post<TResult>(IAtMostOnceCommand<TResult> command) => NavigationSpecification<TResult>.Post(command);

   internal void NavigateOn(IRemoteHypermediaNavigator busSession) => NavigateOnAsync(busSession).WaitUnwrappingException();
   internal abstract Task NavigateOnAsync(IRemoteHypermediaNavigator busSession);
   ...
   class VoidCommand(IAtMostOnceHypermediaCommand command) : NavigationSpecification
   {
      ...
      internal override async Task NavigateOnAsync(IRemoteHypermediaNavigator busSession) => await busSession.PostAsync(_command).CaF();
   }
}
...
public abstract class NavigationSpecification<TResult>
{
   ...
   internal abstract Task<TResult> NavigateOnAsync(IRemoteHypermediaNavigator busSession);
   ...
   class SelectQuery<TPrevious> : NavigationSpecification<TResult>
   {
      ...
      internal override async Task<TResult> NavigateOnAsync(IRemoteHypermediaNavigator busSession)
      {
   ...
   class StartQuery : NavigationSpecification<TResult>
   {
      ...
      internal override async Task<TResult> NavigateOnAsync(IRemoteHypermediaNavigator busSession) => await busSession.GetAsync(_start).CaF();
   }
   ...
   class StartCommand : NavigationSpecification<TResult>
   {
      ...
      internal override async Task<TResult> NavigateOnAsync(IRemoteHypermediaNavigator busSession) => await busSession.PostAsync(_start).CaF();
   }
   ...
   class PostVoidCommand<TPrevious> : NavigationSpecification
   {
      ...
      internal override async Task NavigateOnAsync(IRemoteHypermediaNavigator busSession)
      {
         var previousResult = await _previous.NavigateOnAsync(busSession).CaF();
         var currentCommand = _next(previousResult);
