...
public abstract class EventMigrationTestBase([NotNull] string pluggableComponentsCombination) : DuplicateByPluggableComponentTest(pluggableComponentsCombination)
{
   ...
   protected static IServiceLocator CreateServiceLocatorForEventStoreType(Func<IReadOnlyList<IEventMigration>> migrationsfactory)
   {
      ...
      serviceLocator.Resolve<ITypeMappingRegistar>()
                    ...
                    .Map<Compze.Tests.CQRS.IUserEvent>("059a8d68-9b84-4e6b-85b6-fb3e0f7d9d6f")
                    .Map<Compze.Tests.CQRS.MigratedAfterUserChangedEmailEvent>("ebda8f29-0e76-493f-b4d5-220b9605de13")
                    .Map<Compze.Tests.CQRS.MigratedBeforeUserRegisteredEvent>("3b3477ab-014b-4dbf-921d-8569d7e934e2")
                    .Map<Compze.Tests.CQRS.MigratedReplaceUserChangedPasswordEvent>("fa51dab5-d012-491a-b73e-5b343d9aa2d0")
                    .Map<Compze.Tests.CQRS.UserChangedEmail>("67c06a44-56eb-4b67-b6e5-ef125653ed7c")
                    .Map<Compze.Tests.CQRS.UserChangedPassword>("bbcad7d4-e5f6-45b1-8dd5-99d54b048e3a")
                    .Map<Compze.Tests.CQRS.UserEvent>("507c052d-eeaf-402f-9f2b-91941118caf2")
                    .Map<Compze.Tests.CQRS.UserRegistered>("02feaed0-b540-4402-92b2-30073db53fa1");
