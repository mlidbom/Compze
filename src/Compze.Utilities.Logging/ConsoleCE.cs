...
public static class ConsoleCE
{
   ...
   static readonly IMonitor MonitorCE = IMonitor.WithTimeout(LockTimeout.Seconds(2)); //We are just writing to the console. If this blocks for more than a second or so something is very wrong;
