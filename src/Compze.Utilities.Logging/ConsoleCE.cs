...
public static class ConsoleCE
{
   ...
   static readonly IMonitor MonitorCE = IMonitor.WithTimeout(2.Seconds()); //We are just writing to the console. If this blocks for more than a second or so something is very wrong;
