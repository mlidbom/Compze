...
namespace Compze.Utilities.SystemCE.ReflectionCE.EmitCE;

internal static class AssemblyBuilderCE
{
   public static readonly IThreadShared<ModuleBuilder> Module;
...
internal static class TypeBuilderCE
{
