...
#pragma warning restore CA2000
   ...
   internal class AwaitableProcessShared<TShared>(TShared shared, IAwaitableMutex mutex) : AwaitableShared<TShared>(shared, mutex), IAwaitableProcessShared<TShared>
   {
