...
/// <see cref="NamedPipeTransportRequestKind.EndpointDiscoveryQuery"/> handler a <see cref="NamedPipeTransportServer"/> dispatches to.<br/>
...
{
   public static Func<NamedPipeTransportRequest, Task<string>> CreateFor(EndpointDiscoveryQueryExecutor executor, ITypeMap typeMap) =>
      request =>
      {
