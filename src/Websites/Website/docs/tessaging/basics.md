...
Doing so is called messaging. When message routing is done exclusively via the type of the message, this is called Tessaging.

> [!TIP]     
> Tessaging is messaging where all routing is done via the type of the message.
