...
public static class MySqlDomainDatabaseRegistrar
{
   ///<summary>Declares the domain database this endpoint joins: the MySQL database reached through <paramref name="connectionStringName"/> —<br/>
   ...
   public static IComponentRegistrar MySqlDomainDatabase(this IComponentRegistrar registrar, string connectionStringName) =>
