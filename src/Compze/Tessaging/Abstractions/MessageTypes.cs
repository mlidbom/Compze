   ...
   public static class Remotable
   {
      public static class AtMostOnce
      {
         ...
         public class AtMostOnceHypermediaCommand : IAtMostOnceHypermediaCommand
         {
            ...
            protected AtMostOnceHypermediaCommand(DeduplicationIdHandling scenario) => _deduplicationId = scenario == DeduplicationIdHandling.Create ? Guid.CreateVersion7() : Guid.Empty;
