...
partial class Inbox
{
   //todo:performance: this is a working first draft, but it will hamper parallelism. What we actually need is to ensure that tueries sent from an endpoint are executed after any commands or events sent before them from that endpoint.
