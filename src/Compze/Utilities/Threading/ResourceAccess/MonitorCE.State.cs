...
public partial class MonitorCE
{
   ...
   static readonly TimeSpan InfiniteTimeout = -TimeSpan.FromMilliseconds(1);
#if NCRUNCH
...
#else
   static readonly TimeSpan DefaultTimeout = TimeSpan.FromMinutes(2); //MsSql default tuery timeout is 30 seconds. Default .Net transaction timeout is 60. If we reach 2 minutes it is all but guaranteed that we have an in-memory deadlock.
#endif
