...
static class UncatchableExceptionsGatherer
{
   ...
   ///<summary>If writing tests to ensure uncatchable exceptions are registered, you need to prtevent others from running similar tests at the same time. Use this monitor for that</summary>
