...
/// <summary>
/// Type-safe version of PluggableComponentsTheoryAttribute with three component dimensions.
...
public abstract class TypedPluggableComponentsTheoryAttribute<TComponent1, TComponent2, TComponent3> : PluggableComponentsTheoryAttribute
   ...
   where TComponent3 : Enum
{
   ...
   /// </summary>
   /// <param name="skippedComponents">Array of enum values to skip (can be any of TComponent1, TComponent2, or TComponent3)</param>
