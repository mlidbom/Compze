...
public partial class DbPool : StrictlyManagedResourceBase<DbPool>
{
   ...
   public void SetLogLevel(LogLevel logLevel) => _lock.Update(() => _log = _log.WithLogLevel(logLevel));

   public string ConnectionStringFor(string reservationName) => _lock.Update(() =>
   {
