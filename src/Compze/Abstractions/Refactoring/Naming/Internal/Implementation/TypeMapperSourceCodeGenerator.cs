...
{
   internal const string MappingClassName = "AutoGeneratedCurrentAssemblyTypeMapperForRefactoringSupport";
   internal const string MappingFileName = $"{MappingClassName}.cs";
   const int MaxDirectoryLevelsToSearchUp = 6;

   internal static string GenerateAutoGeneratedClassCode(string? rootNamespace, ISet<Type> typesToMap, Dictionary<Type, TypeId> existingMappings)
   {
   ...
   internal static string? TryFindProjectFileAndCreateMapping(Assembly assembly, ISet<Type> typesToMap, Dictionary<Type, TypeId> existingMappings)
   {
