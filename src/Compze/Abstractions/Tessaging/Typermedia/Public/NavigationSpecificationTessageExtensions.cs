...
public static class NavigationSpecificationTessageExtensions
{
   ...
   public static NavigationSpecification<TResult> Post<TResult>(this IAtMostOnceTypermediaTommand<TResult> tommand) => NavigationSpecification.Post(tommand);
   ...
   public static TResult PostOn<TResult>(this IAtMostOnceTypermediaTommand<TResult> tommand, IRemoteTypermediaNavigator bus) => NavigationSpecification.Post(tommand).NavigateOn(bus);
