...
public abstract class NavigationSpecification
{
   ...
   public static NavigationSpecification<TResult> Post<TResult>(IAtMostOnceTypermediaTommand<TResult> tommand) => NavigationSpecification<TResult>.Post(tommand);
...
public abstract class NavigationSpecification<TResult>
{
   ...
   internal static NavigationSpecification<TResult> Post(IAtMostOnceTypermediaTommand<TResult> tommand) => new StartTommand(tommand);
