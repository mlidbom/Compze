...
public static class MemoryPackInterprocessObject
{
   ...
   ///</summary>
   public static IInterprocessObject<T> NewGlobal<T>(string name, Func<T> createDefault, CorruptionAction corruptionAction, int maxCapacityInBytes, DirectoryInfo? directory = null, LockTimeout? lockTimeout = null, WaitTimeout? waitTimeout = null) where T : class
      => IInterprocessObject.NewGlobal(name, MemoryPackInterprocessObjectSerializer<T>.Instance, createDefault, corruptionAction, maxCapacityInBytes, directory, lockTimeout, waitTimeout);
   ...
   public static IInterprocessObject<T> NewLocal<T>(string name, Func<T> createDefault, CorruptionAction corruptionAction, int maxCapacityInBytes, DirectoryInfo? directory = null, LockTimeout? lockTimeout = null, WaitTimeout? waitTimeout = null) where T : class
   ...
   public static IInterprocessObject<T> NewGlobalFileBacked<T>(string name, Func<T> createDefault, CorruptionAction corruptionAction, DirectoryInfo? directory = null, LockTimeout? lockTimeout = null, WaitTimeout? waitTimeout = null) where T : class
   ...
   public static IInterprocessObject<T> NewLocalFileBacked<T>(string name, Func<T> createDefault, CorruptionAction corruptionAction, DirectoryInfo? directory = null, LockTimeout? lockTimeout = null, WaitTimeout? waitTimeout = null) where T : class
