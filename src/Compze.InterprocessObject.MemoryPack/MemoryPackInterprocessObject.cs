...
public static class MemoryPackInterprocessObject
{
   ...
   ///</summary>
   public static IInterprocessObject<T> NewGlobal<T>(string name, Func<T> createDefault, CorruptionAction corruptionAction, int maxCapacityInBytes, DirectoryInfo directory, LockTimeout? lockTimeout = null, WaitTimeout? waitTimeout = null) where T : class
