...
#pragma warning disable CA2000 // Mutex ownership transfers to ProcessShared which disposes it
   ...
   public static IProcessShared<TShared> Global<TShared>(string name, TShared shared, LockTimeout? timeout = null, Action? onAbandonedMutexException = null) =>
      new ProcessShared<TShared>(shared, IMutex.Global(name, timeout, onAbandonedMutexException));
   ...
   public static IProcessShared<TShared> Local<TShared>(string name, TShared shared, LockTimeout? timeout = null, Action? onAbandonedMutexException = null) =>
      new ProcessShared<TShared>(shared, IMutex.Local(name, timeout, onAbandonedMutexException));
