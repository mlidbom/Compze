...
/// </summary>
public partial interface IAwaitableMutex : IMutex, IAwaitableLock
{
   ...
   public static IAwaitableMutex GlobalNamed(string name, LockTimeout? lockTimeout = null, WaitTimeout? waitTimeout = null, PollingInterval? pollingInterval = null, Action? onAbandonedMutex = null) =>
      new AwaitableMutexCE(name, global: true, lockTimeout, waitTimeout, pollingInterval, onAbandonedMutex);
   ...
   public static IAwaitableMutex LocalNamed(string name, LockTimeout? lockTimeout = null, WaitTimeout? waitTimeout = null, PollingInterval? pollingInterval = null, Action? onAbandonedMutex = null) =>
      new AwaitableMutexCE(name, global: false, lockTimeout, waitTimeout, pollingInterval, onAbandonedMutex);
