...
public static class PgSqlEndpointPersistenceRegistrar
{
   ///<summary>Declares the endpoint's persistence: the PostgreSQL database reached through <paramref name="connectionStringName"/> —<br/>
   ...
   public static IComponentRegistrar PgSqlEndpointPersistence(this IComponentRegistrar registrar, string connectionStringName) =>
