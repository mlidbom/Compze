...
using Compze.ServiceBus.Implementation;
using Compze.ServiceBus.Implementation.Abstractions;
using Compze.ServiceBus.Implementation.Outbox;
using Compze.Tessaging.Implementation.TessageHandling.Abstractions;
using Compze.Tessaging.Implementation.TessageHandling.Dispatching;
using Compze.ServiceBus.Implementation.TessageHandling.Inbox;
using Compze.ServiceBus.Implementation.Transport;
using Compze.ServiceBus.Implementation.Transport.Abstractions;
using Compze.ServiceBus.Implementation.Transport.Client.Implementation.Universal;
using Compze.ServiceBus.Implementation.Transport.Client.Routing;
...
public class TessagingEndpointFeature
{
   ...
   internal TessagingEndpointFeature(IEndpointBuilder builder)
   {
      ...
      builder.OnContainerBuilt(resolver => ServiceBusInfrastructureQueryRegistration.RegisterQueryHandlers(
