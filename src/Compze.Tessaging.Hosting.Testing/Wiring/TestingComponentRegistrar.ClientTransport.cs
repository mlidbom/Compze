...
public static class TestingComponentRegistrarClientTransport
{
   ...
   public static IComponentRegistrar CurrentTestsClientTransport(this TestingComponentRegistrar @this)
   {
