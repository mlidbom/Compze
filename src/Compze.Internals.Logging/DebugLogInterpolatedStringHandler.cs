...
public ref struct DebugLogInterpolatedStringHandler
{
   ...
   public DebugLogInterpolatedStringHandler(int literalLength, int formattedCount, ILogger logger, out bool enabled)
   {
      enabled = !CompzeLogger.LoggingSuppressed && logger.IsEnabled(LogLevel.Debug);
