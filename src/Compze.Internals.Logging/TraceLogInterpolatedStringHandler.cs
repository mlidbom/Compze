...
public ref struct TraceLogInterpolatedStringHandler
{
   ...
   public TraceLogInterpolatedStringHandler(int literalLength, int formattedCount, ILogger logger, out bool enabled)
   {
      enabled = !CompzeLogger.LoggingSuppressed && logger.IsEnabled(LogLevel.Trace);
