...
- `AutofacContainer.CreateCloneContainerBuilder` is `protected`: only the base class calls it, so it leaves the public surface. Breaking for anyone who called it directly, which the narrowing established nobody does.
