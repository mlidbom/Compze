...
public static class TrackedTransient
{
   ...
   /// together by <see cref="IServiceResolverCE.ResolveSet{TComponent}(Compze.DependencyInjection.Runtime.Resolution.IServiceResolver)"/>.
   /// </summary>
   /// <remarks>
