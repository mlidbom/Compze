...
/// (<see cref="ComponentRegistrationWithoutInstantiationSpecAssociatedRegistrationsExtensions"/>'s deferred <c>WithAssociatedRegistrations()</c> modifier); the
...
/// </remarks>
public static class ComponentRegistrationWithoutInstantiationSpecServiceResolverExtensions
{
   ...
   static readonly MethodInfo CreateTypedServiceResolverRegistrationDefinition =
      typeof(ComponentRegistrationWithoutInstantiationSpecServiceResolverExtensions).GetMethod(nameof(CreateTypedServiceResolverRegistration), BindingFlags.NonPublic | BindingFlags.Static)!;
