...
public abstract class ComponentRegistration
{
   ...
   /// <summary>
   /// Whether this registration joins a <see cref="IServiceResolverCE.ResolveSet{TComponent}(Compze.DependencyInjection.Runtime.Resolution.IServiceResolver)"/>-only
