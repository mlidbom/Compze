...
/// </summary>
public static class ComponentRegistrationWithoutInstantiationSpecCE
{
   extension<TSpec>(TSpec @this) where TSpec : ComponentRegistrationWithoutInstantiationSpec
   {
      ...
      /// This is what feature extensions such as <see cref="ServiceResolverExtensions"/>'s <c>WithServiceResolver()</c> build on.
      /// </remarks>
      public TSpec WithAssociatedRegistrations(Func<ComponentRegistration, IEnumerable<ComponentRegistration>> createAssociatedRegistrations)
      {
