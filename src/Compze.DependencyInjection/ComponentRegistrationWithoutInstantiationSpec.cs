...
/// <summary>
/// The configuration phase of a fluent component registration: the component's service types, <see cref="Abstractions.Lifestyle"/>,
...
/// <see cref="ComponentRegistrationWithoutInstantiationSpecCE"/>'s <c>WithAssociatedRegistrations()</c> and
/// <see cref="ServiceResolverExtensions"/>'s <c>WithServiceResolver()</c> — can be generic extensions constrained on it,
