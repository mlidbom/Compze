...
- `NewtonsoftSerializer()`: fills a feature composition's Tessaging- or Typermedia-serializer slot — e.g. `AddDistributedTessaging(tessaging => tessaging.NewtonsoftSerializer())`.
