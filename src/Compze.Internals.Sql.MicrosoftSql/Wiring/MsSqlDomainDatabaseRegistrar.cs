...
public static class MsSqlDomainDatabaseRegistrar
{
   ///<summary>Declares the domain database this endpoint joins: the SQL Server database reached through <paramref name="connectionStringName"/> —<br/>
   ...
   public static IComponentRegistrar MsSqlDomainDatabase(this IComponentRegistrar registrar, string connectionStringName) =>
