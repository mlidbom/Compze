...
namespace Compze.Internals.Sql.PostgreSql._private;
...
/// <see cref="Wiring._internal.PgSqlSchemaContributionRegistrar.PgSqlSchemaContribution"/>, as a component set member — and the<br/>
