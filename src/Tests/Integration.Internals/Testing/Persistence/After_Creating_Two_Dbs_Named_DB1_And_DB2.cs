...
public class After_Creating_Two_Dbs_Named_DB1_And_DB2(string pluggableComponentsCombination) : DbPoolTest(pluggableComponentsCombination)
{
   ...
   static string LayerSpecificCommandText() => TestEnv.PersistenceLayer.ValueFor(db2: "select 1 from sysibm.sysdummy1", msSql: "select 1", mySql: "select 1", orcl: "select 1 from dual", pgSql: "select 1", memory:"nonsense");
