...
using Compze.Tessaging.Teventive.EventStore.Tuery.Models.Generators;
   ...
   namespace Domain
   {
      namespace UI
      {
         namespace QueryModels
         {
            ...
            public class AccountQueryModelGenerator : SingleAggregateQueryModelGenerator<AccountQueryModelGenerator, MyAccountQueryModel, AccountEvents.IAccountTevent, IEventStoreReader>
            {
      ...
      class MyAccount : Aggregate<MyAccount, AccountEvents.IAccountTevent, AccountEvents.AccountTevent>
      {
         MyAccount() : base(new DateTimeNowTimeSource())
         {
            RegisterEventAppliers()
              ...
              .For<AccountEvents.IAccountDeletedTevent>(_ => {});
         }

         public string Email { get; private set; } = "";
         public string Password { get; private set; } = "";

         public void ChangeEmail(string newEmail) => Publish(new AccountEvents.Implementation.EmailChangedTevent(newEmail));
         ...
         public static MyAccount Register(IEventStoreUpdater aggregates, Guid accountId, string email, string password)
         {
            ...
            registered.Publish(new AccountEvents.Implementation.AccountRegisteredTevent(accountId, email, password));
            aggregates.Save(registered);
            return registered;
         }

         public void Delete() => Publish(new AccountEvents.Implementation.AccountDeletedTevent());
      }
      ...
      public static class AccountEvents
      {
         ...
         internal static class Implementation
         {
            ...
            public class EmailChangedTevent(string newEmail) : AccountTevent, IEmailChangedEvent
            {
