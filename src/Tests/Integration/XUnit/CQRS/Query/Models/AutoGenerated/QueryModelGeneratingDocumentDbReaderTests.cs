...
namespace Compze.Tests.Integration.XUnit.CQRS.Query.Models.AutoGenerated
{
   public class QueryModelGeneratingQueryModelReaderTests : UniversalTestBase, IAsyncLifetime
   {
      ...
      public async Task DisposeAsync() => await _serviceLocator.DisposeAsync();
