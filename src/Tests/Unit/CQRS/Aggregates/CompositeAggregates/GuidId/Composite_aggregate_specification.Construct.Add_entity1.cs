...
public static partial class Composite_aggregate_specification
{
   public partial class After_constructing_root_aggregate_with_name_root_and_slaving_a_tuery_model_to_the_aggregates_events
   {
      public partial class After_adding_entity_named_entity1 : After_constructing_root_aggregate_with_name_root_and_slaving_a_tuery_model_to_the_aggregates_events
      {
         ...
         {
            [XF] public void Single_returns_the_entity_tuery_model() => _queryModel.Entities.Single().Should().Be(_qmEntity1);
            [XF] public void InCreationOrder_0_returns_the_entity_tuery_model() => _queryModel.Entities.InCreationOrder[0].Should().Be(_qmEntity1);
            ...
            public class Passing_the_entitys_id_to : The_QueryModels_Entities_collection
            {
               ...
               [XF] public void Get_returns_the_entity_tuery_model() => _queryModel.Entities.Get(_entity1.Id).Should().Be(_qmEntity1);
