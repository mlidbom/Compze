         ...
         public partial class After_calling_AddEntity_with_name_entity1_and_a_newGuid
         {
            public partial class After_calling_AddEntity_with_name_entity2_and_a_newGuid
            {
               public partial class After_calling_entity2_Remove : After_calling_AddEntity_with_name_entity2_and_a_newGuid
               {
                  ...
                  {
                     [XF] public void Single_return_entity1() => _component.Entities.Single().Should().Be(_entity1);
                     [XF] public void InCreationOrder_1_throws() => FluentActions.Invoking(() => _component.Entities.InCreationOrder[1]).Should().Throw<Exception>();
                     [XF] public void InCreationOrder_Count_is_1() => _component.Entities.InCreationOrder.Count.Should().Be(1);

                     public class Passing_the_entity2_id_to : The_Entities_collection__
                     {
                        [XF] public void Contains_returns_false() => _component.Entities.Contains(_entity2.Id).Should().Be(false);
                        [XF] public void Get_throws() => FluentActions.Invoking(() => _component.Entities.Get(_entity2.Id)).Should().Throw<Exception>();
                        [XF] public void Indexer_throws() => FluentActions.Invoking(() => _component.Entities[_entity2.Id]).Should().Throw<Exception>();
                  ...
                  {
                     [XF] public void Single_return_entity1() => _qmComponent.Entities.Single().Should().Be(_qmEntity1);
                     [XF] public void InCreationOrder_1_throws() => FluentActions.Invoking(() => _qmComponent.Entities.InCreationOrder[1]).Should().Throw<Exception>();
                     ...
                     {
                        [XF] public void Contains_returns_false() => _qmComponent.Entities.Contains(_entity2.Id).Should().Be(false);
                        [XF] public void Get_throws() => FluentActions.Invoking(() => _qmComponent.Entities.Get(_entity2.Id)).Should().Throw<Exception>();
                        [XF] public void Indexer_throws() => FluentActions.Invoking(() => _qmComponent.Entities[_entity2.Id]).Should().Throw<Exception>();
