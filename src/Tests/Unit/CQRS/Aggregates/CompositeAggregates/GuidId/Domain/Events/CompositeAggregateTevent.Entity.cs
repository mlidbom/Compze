...
static partial class CompositeAggregateTevent
{
   ...
   {
      public interface IRoot : CompositeAggregateTevent.ICompositeAggregateTevent
      {
         Guid EntityId { get; }
      }
      ...
      {
         public abstract class Root : CompositeAggregateTevent.Implementation.Root, Entity.IRoot
         {
            public Guid EntityId { get; protected set; }

#pragma warning disable CA1812 // Used via reflection in aggregate infrastructure
            [UsedImplicitly] public class IdGetterSetter : IGetSetAggregateEntityTeventEntityId<Guid, Root, IRoot>
