...
static partial class CompositeAggregateTevent
{
   public static partial class Component
   {
      ...
      {
         public interface IRoot : CompositeAggregateTevent.Component.IRoot
         {
            Guid EntityId { get; }
         }
         ...
         {
            public abstract class Root : CompositeAggregateTevent.Component.Implementation.Root, Entity.IRoot
            {
