      ...
      public partial class After_adding_entity_named_entity1
      {
         public partial class After_adding_entity_named_entity2
         {
            public partial class After_calling_entity2_Remove : After_adding_entity_named_entity2
            {
               ...
               {
                  [XF] public void Single_return_entity1() => _aggregate.Entities.Single().Should().Be(_entity1);
                  [XF] public void InCreationOrder_1_throws() => Invoking(() => _aggregate.Entities.InCreationOrder[1]).Should().Throw<Exception>();
                  ...
                  {
                     [XF] public void Contains_returns_false() => _aggregate.Entities.Contains(_entity2.Id).Should().Be(false);
                     [XF] public void Get_throws() => Invoking(() => _aggregate.Entities.Get(_entity2.Id)).Should().Throw<Exception>();
                     [XF] public void Indexer_throws() => Invoking(() => _aggregate.Entities[_entity2.Id]).Should().Throw<Exception>();
