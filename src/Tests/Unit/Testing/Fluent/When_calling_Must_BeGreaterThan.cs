...
public class When_calling_Must_BeGreaterThan : UniversalTestBase
{
   ...
   {
      [XF] public void it_does_not_throw() => Must___IComparableAssertions.BeGreaterThan(__Must.Must(10), 5);
   }

   public class with_a_value_equal_to_the_actual_value : When_calling_Must_BeGreaterThan
   {
      [XF] public void it_throws() => Invoking(() => Must___IComparableAssertions.BeGreaterThan(__Must.Must(5), 5))
                                     .Must()
   ...
   {
      [XF] public void it_throws() => Invoking(() => Must___IComparableAssertions.BeGreaterThan(__Must.Must(3), 5))
                                     .Must()
                                     .Throw<AssertionFailedException>();
   }
}
