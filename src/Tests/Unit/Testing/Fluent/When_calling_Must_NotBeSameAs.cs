...
public class When_calling_Must_NotBeSameAs : UniversalTestBase
{
   ...
   {
      [XF] public void it_does_not_throw() => new ValueWrapper<int>(42)
                                             .Must().NotBeSameInstanceAs(new ValueWrapper<int>(42));
   }
   ...
   public class with_two_references_to_the_same_object : When_calling_Must_NotBeSameAs
   {
      ...
      [XF] public void it_throws() => Invoking(() => _actual.Must().NotBeSameInstanceAs(_actual))
                                     .Must()
