...
class AssemblyTypeMapper : IAssemblyTypeMapper
{
   public void Map(IAssemblyTypeMappingRegistrar map)
   {
      map.Map<IExactlyOnceTevent>("0d68a831-87c0-4d05-8e52-bf063d51b56d")
         ...
         .MapOpenGeneric(typeof(IPublisherIdentifyingTevent<>), "a6907e78-2e6c-4674-a426-78008791b0a0")
         .MapOpenGeneric(typeof(IRemotablePublisherIdentifyingTevent<>), "a6452baa-2e5e-484a-8455-a514576f081f")
         .MapOpenGeneric(typeof(IExactlyOncePublisherIdentifyingTevent<>), "c7935ee3-38fe-482d-82d2-9797fb6e2435")
