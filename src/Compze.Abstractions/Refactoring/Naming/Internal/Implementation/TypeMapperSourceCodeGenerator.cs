...
static class TypeMapperSourceCodeGenerator
{
   public const string MappingClassName = "AutoGeneratedCurrentAssemblyTypeMapperForRefactoringSupport";
   public const string MappingMethodName = "MapTypesForCurrentAssembly";
   ...
   public static string? TryFindProjectFileAndCreateMapping(Assembly assembly, ISet<Type> typesToMap, Dictionary<Type, TypeId> existingMappings)
   {
      ...
      //todo: Auto-generation disabled to avoid chaos during build/test cycles.
      // The generated code is still included in the exception message for manual use.
