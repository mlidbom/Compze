...
{
    ///<summary>Declares an endpoint. The <paramref name="setup"/> callback receives the endpoint's <see cref="IEndpointBuilder"/>: add capabilities (such as <c>AddTessaging()</c> / <c>AddTypermedia()</c>), register handlers, and register the endpoint's own components.</summary>
