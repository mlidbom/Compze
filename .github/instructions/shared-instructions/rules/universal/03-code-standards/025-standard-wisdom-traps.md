...
thing as the *kind* of thing it is *now* — an entity → a class with identity, a value → a record/struct; that
is a present truth, not a future feature. YAGNI withholds only *behavior/members nothing yet calls*: right
nature now, members when needed.