...
internal abstract class MachineWideSharedObject
{
...
internal enum CorruptionAction
{
   ThrowException = 0,
   ReplaceContentWithDefaultAndThrow = 1
}

internal sealed class MachineWideSharedObject<TObject> : MachineWideSharedObject where TObject : class, new()
{
