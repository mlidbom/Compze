...
public static class ConsoleCE
{
   ...
   static readonly IMonitorCE MonitorCE = IMonitorCE.WithTimeouts(2.Seconds()); //We are just writing to the console. If this blocks for more than a second or so something is very wrong;
   ...
   public static void WriteLine(string message) => MonitorCE.Update(() => Console.WriteLine(message));
