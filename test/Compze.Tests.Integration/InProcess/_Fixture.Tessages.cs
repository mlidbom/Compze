...
///<summary>A hand-built <see cref="ITaggregateTevent"/>, for publishing through an <c>ITeventStoreTeventPublisher</c> without a taggregate or tevent store in the composition.</summary>
