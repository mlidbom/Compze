...
public static partial class NamespaceVisibilityPolicy
{
   ...
   static class KnownViolations
   {
      ...
      [
         ...
         "Compze.Tessaging.Internal.TessagesInFlight.TessagesInFlightTracker",
         "Compze.Tessaging.Internal.TessagesInFlight.TessagesInFlightTracker+InFlightTessage",
         "Compze.Tessaging.Internal.Transport.Advertisement.EndpointInformation",
         "Compze.Tessaging.Internal.Transport.Advertisement.EndpointInformationQueryExecutor",
         "Compze.Tessaging.Internal.Transport.Advertisement.EndpointInformationQueryRegistrarWithDependencyInjectionSupport",
         "Compze.Tessaging.Internal.Transport.ProblemDetails",
         "Compze.Tessaging.Internal.Transport.TransportTessage",
         "Compze.Tessaging.Internal.Transport.TransportTessage+InComing",
         "Compze.Tessaging.Internal.Transport.TransportTessage+OutGoing",
         ...
         "Compze.Tessaging.Typermedia.Internal.ITypermediaSerializer",
