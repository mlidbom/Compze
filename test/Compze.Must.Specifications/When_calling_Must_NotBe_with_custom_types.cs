      ...
      [XF] public void it_throws_and_the_full_message_is() =>
         Invoking(() => _actual.Must().NotBe(_unexpected))
           ...
           .Which.Message.Must().Be("""
                                    ...
                                    @@ -1,5 +1,5 @@
                                     {
                                       "$type": "Compze.Must.Specifications.ComparableWithErrorInjectionSupport, Compze.Must.Specifications",
                                    ...
                                    --------------------------------------------------
                                    _actual was a Compze.Must.Specifications.ComparableWithErrorInjectionSupport with:
                                    --------------------------------------------------
                                    JSON:
                                    --------------------------------------------------
                                    {
                                    ...
                                    --------------------------------------------------
                                    _unexpected was a Compze.Must.Specifications.ComparableWithErrorInjectionSupport with:
                                    --------------------------------------------------
                                    JSON:
                                    --------------------------------------------------
                                    {
