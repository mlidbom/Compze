...
public class Given_an_endpoint_navigating_a_typermedia_type_with_no_live_route : UniversalTestBase
{
   ...
   /// that serves the type and is down — known-but-down with no process behind it.</summary>
   ...
   {
      var tueryTypeIdString = _navigatorEndpoint.ServiceLocator.Resolve<ITypeMap>().GetId(typeof(TueryNothingServes)).CanonicalString;
