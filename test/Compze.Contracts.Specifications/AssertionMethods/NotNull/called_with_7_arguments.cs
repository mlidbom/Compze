...
public class called_with_7_arguments : AssertionMethodsTest
{
   ...
   public class throws_if : called_with_7_arguments
   {
      [XF] public void argument_1_is_null() =>
         Invoking(() => Asserter.NotNull7(NullString, "b", "c", "d", "e", "f", "g")).Must().Throw<AssertionTestException>();

      [XF] public void argument_2_is_null() =>
         Invoking(() => Asserter.NotNull7("a", NullString, "c", "d", "e", "f", "g")).Must().Throw<AssertionTestException>();

      [XF] public void argument_3_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", NullString, "d", "e", "f", "g")).Must().Throw<AssertionTestException>();

      [XF] public void argument_4_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", "c", NullString, "e", "f", "g")).Must().Throw<AssertionTestException>();

      [XF] public void argument_5_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", "c", "d", NullString, "f", "g")).Must().Throw<AssertionTestException>();

      [XF] public void argument_6_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", "c", "d", "e", NullString, "g")).Must().Throw<AssertionTestException>();

      [XF] public void argument_7_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", "c", "d", "e", "f", NullString)).Must().Throw<AssertionTestException>();
   }
   ...
   public class exception_message_contains_the_argument_expression_if : called_with_7_arguments
   {
      ...
      [XF] public void argument_1_is_null() =>
         Invoking(() => Asserter.NotNull7(NullArg1, "b", "c", "d", "e", "f", "g"))
            .Must().Throw<AssertionTestException>()
            .Which.Message.Must().Contain(nameof(NullArg1));

      [XF] public void argument_2_is_null() =>
         Invoking(() => Asserter.NotNull7("a", NullArg2, "c", "d", "e", "f", "g"))
            .Must().Throw<AssertionTestException>()
            .Which.Message.Must().Contain(nameof(NullArg2));

      [XF] public void argument_3_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", NullArg3, "d", "e", "f", "g"))
            .Must().Throw<AssertionTestException>()
            .Which.Message.Must().Contain(nameof(NullArg3));

      [XF] public void argument_4_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", "c", NullArg4, "e", "f", "g"))
            .Must().Throw<AssertionTestException>()
            .Which.Message.Must().Contain(nameof(NullArg4));

      [XF] public void argument_5_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", "c", "d", NullArg5, "f", "g"))
            .Must().Throw<AssertionTestException>()
            .Which.Message.Must().Contain(nameof(NullArg5));

      [XF] public void argument_6_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", "c", "d", "e", NullArg6, "g"))
            .Must().Throw<AssertionTestException>()
            .Which.Message.Must().Contain(nameof(NullArg6));

      [XF] public void argument_7_is_null() =>
         Invoking(() => Asserter.NotNull7("a", "b", "c", "d", "e", "f", NullArg7))
            .Must().Throw<AssertionTestException>()
