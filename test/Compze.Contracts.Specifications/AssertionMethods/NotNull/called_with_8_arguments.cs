...
public class called_with_8_arguments : AssertionMethodsTest
{
   ...
   public class throws_with_message_containing_the_failing_argument_expression_if : called_with_8_arguments
   {
      ...
      [XF] public void argument_1_is_null() =>
         MustThrowContaining(() => Asserter.NotNull8(NullArg1, "b", "c", "d", "e", "f", "g", "h"), nameof(NullArg1));

      [XF] public void argument_2_is_null() =>
         MustThrowContaining(() => Asserter.NotNull8("a", NullArg2, "c", "d", "e", "f", "g", "h"), nameof(NullArg2));

      [XF] public void argument_3_is_null() =>
         MustThrowContaining(() => Asserter.NotNull8("a", "b", NullArg3, "d", "e", "f", "g", "h"), nameof(NullArg3));

      [XF] public void argument_4_is_null() =>
         MustThrowContaining(() => Asserter.NotNull8("a", "b", "c", NullArg4, "e", "f", "g", "h"), nameof(NullArg4));

      [XF] public void argument_5_is_null() =>
         MustThrowContaining(() => Asserter.NotNull8("a", "b", "c", "d", NullArg5, "f", "g", "h"), nameof(NullArg5));

      [XF] public void argument_6_is_null() =>
         MustThrowContaining(() => Asserter.NotNull8("a", "b", "c", "d", "e", NullArg6, "g", "h"), nameof(NullArg6));

      [XF] public void argument_7_is_null() =>
         MustThrowContaining(() => Asserter.NotNull8("a", "b", "c", "d", "e", "f", NullArg7, "h"), nameof(NullArg7));

      [XF] public void argument_8_is_null() =>
         MustThrowContaining(() => Asserter.NotNull8("a", "b", "c", "d", "e", "f", "g", NullArg8), nameof(NullArg8));
   }
}
