...
public class called_with_5_arguments : AssertionMethodsTest
{
   ...
   public class throws_with_message_containing_the_failing_argument_expression_if : called_with_5_arguments
   {
      ...
      [XF] public void argument_1_is_null() =>
         MustThrowContaining(() => Asserter.NotNull5(NullArg1, "b", "c", "d", "e"), nameof(NullArg1));

      [XF] public void argument_2_is_null() =>
         MustThrowContaining(() => Asserter.NotNull5("a", NullArg2, "c", "d", "e"), nameof(NullArg2));

      [XF] public void argument_3_is_null() =>
         MustThrowContaining(() => Asserter.NotNull5("a", "b", NullArg3, "d", "e"), nameof(NullArg3));

      [XF] public void argument_4_is_null() =>
         MustThrowContaining(() => Asserter.NotNull5("a", "b", "c", NullArg4, "e"), nameof(NullArg4));

      [XF] public void argument_5_is_null() =>
         MustThrowContaining(() => Asserter.NotNull5("a", "b", "c", "d", NullArg5), nameof(NullArg5));
   }
}
