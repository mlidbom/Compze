...
public class called_with_5_arguments : NotNullEmptyOrWhitespaceTest
{
   [XF] public void does_not_throw_if_all_are_non_whitespace() =>
      Asserter.NotNullEmptyOrWhitespace5("v", "v", "v", "v", "v").Must().Be(Asserter);

   [XF] public void argument_1_throws_with_expression_for_each_invalid_value()
   {
      MustThrowContainingForEach(InvalidValues,
         invalidValue => Asserter.NotNullEmptyOrWhitespace5(invalidValue, "v", "v", "v", "v"),
         "invalidValue");
   }
   ...
   {
      MustThrowContainingForEach(InvalidValues,
         invalidValue => Asserter.NotNullEmptyOrWhitespace5("v", invalidValue, "v", "v", "v"),
         "invalidValue");
   }
   ...
   {
      MustThrowContainingForEach(InvalidValues,
         invalidValue => Asserter.NotNullEmptyOrWhitespace5("v", "v", invalidValue, "v", "v"),
         "invalidValue");
   }
   ...
   {
      MustThrowContainingForEach(InvalidValues,
         invalidValue => Asserter.NotNullEmptyOrWhitespace5("v", "v", "v", invalidValue, "v"),
         "invalidValue");
   }
   ...
   {
      MustThrowContainingForEach(InvalidValues,
         invalidValue => Asserter.NotNullEmptyOrWhitespace5("v", "v", "v", "v", invalidValue),
         "invalidValue");
   }
}
