...
public class called_with_4_bool_arguments : AssertionMethodsTest
{
   ...
   public class throws_with_message_containing_the_failing_argument_expression_if : called_with_4_bool_arguments
   {
      ...
      [XF] public void argument_1_is_invalid() =>
         MustThrowContaining(() => Asserter.Assert(Condition1, true, true, true), nameof(Condition1));

      [XF] public void argument_2_is_invalid() =>
         MustThrowContaining(() => Asserter.Assert(true, Condition2, true, true), nameof(Condition2));

      [XF] public void argument_3_is_invalid() =>
         MustThrowContaining(() => Asserter.Assert(true, true, Condition3, true), nameof(Condition3));

      [XF] public void argument_4_is_invalid() =>
         MustThrowContaining(() => Asserter.Assert(true, true, true, Condition4), nameof(Condition4));
   }
}
