...
namespace Compze.DependencyInjection.Specifications.Microsoft.AspNetCore_integration;
...
public class When_CompzeMicrosoftServiceProviderFactory_is_used_with_a_real_AspNetCore_server : IAsyncLifetime
{
   WebApplication? _app;
   HttpClient? _client;
   readonly MicrosoftDependencyInjectionContainer _compzeContainer = new();
   ...
   public class singleton_services : When_CompzeMicrosoftServiceProviderFactory_is_used_with_a_real_AspNetCore_server
   {
   ...
   public class scoped_services : When_CompzeMicrosoftServiceProviderFactory_is_used_with_a_real_AspNetCore_server
   {
   ...
   public class aspnetcore_framework_services : When_CompzeMicrosoftServiceProviderFactory_is_used_with_a_real_AspNetCore_server
   {
