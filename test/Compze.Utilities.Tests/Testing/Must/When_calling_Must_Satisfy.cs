   ...
   public class given_a_complex_object_as_actual_and_a_predicate_that_returns_false : When_calling_Must_Satisfy
   {
      ...
      [XF] public void it_throws_and_the_full_message_is() =>
         ExceptionMessage().Must().Be("""
                                      ...
                                      --------------------------------------------------
                                      {
                                        "$type": "Compze.Utilities.Tests.Testing.Must.When_calling_Must_Satisfy+given_a_complex_object_as_actual_and_a_predicate_that_returns_false+TestObject, Compze.Utilities.Tests",
                                        "Age": 30,
                                        "EqualityContract": "Compze.Utilities.Tests.Testing.Must.When_calling_Must_Satisfy+given_a_complex_object_as_actual_and_a_predicate_that_returns_false+TestObject, Compze.Utilities.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null",
                                        "Name": "John",
                                        "Status": "Unmarried"
                                      }
                                      --------------------------------------------------
