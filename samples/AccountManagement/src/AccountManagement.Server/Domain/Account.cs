...
class Account : Taggregate<Account, IAccountTevent, AccountTevent, IAccountTevent<IAccountTevent>, AccountTevent<AccountTevent>>, IAccountResourceData
{
   ...
   /// </summary>
   internal static (RegistrationAttemptStatus Status, Account? Registered) Register(AccountId accountId, Email email ,Password password, ILocalTypermediaNavigatorSession navigator)
   {
